...
import { Card, CardActions, CardContent, Button, Typography, Zoom, Box } from '@mui/material';
...
export function ProductosCanje() {
    ...
    const renderCards = () => {
        return map(productos, (producto, index) => (
            ...
            >
                <Card key={index} sx={{ width: 200, marginBottom: 5, marginLeft: 5, marginRight: 5, display: 'flex', flexDirection: 'column' }}>
                    <Image
                        src={producto.imagen}
                        alt={producto.nombre}
                        width={200}
